...
public final class LunarCalendar {
     ...
     * 农历月份第一天转写
     */
    public static String[] MONTH_STR = null;
     ...
     * 农历大写
     */
    public static String[] DAY_STR = null;
   ...
   public static String numToChineseMonth1(int month,int leap)
    {
        if(leap==1){
            return "闰" + MONTH_STR[month - 1];
        }
